# osuBeatmapGrabber
## old-client repository

This repository is the old visual basic client repository for [osuBeatmapGrabber](https://osu.ppy.sh/forum/t/399719).

The Client (Version Key vbc) is the tool users using locally until the c# client is finnished. Current release is **vbc0.4.3**
